...
In the GGH v2 soft refinement, rather than binary selection probabilities, each hypothesis receives a continuous weight between $w_{\min}$ and 1.0. Figure~\ref{fig:weight_dist} presents the weight distributions for correct and incorrect hypotheses across representative datasets. In an ideal scenario, correct hypotheses would cluster near weight 1.0, while incorrect hypotheses would cluster near $w_{\min}$. The separation between these two distributions indicates the algorithm's ability to distinguish correct from incorrect hypotheses. The weight distributions also include known partial correct data, which enters the final training at weight 1.0 regardless of the scoring outcome.

% Weight distribution figure
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{figures/photocell_weight_distributions.png}
        \caption{Photocell Degradation}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{figures/airfoil_weight_distributions.png}
        \caption{Airfoil Self-Noise}
    \end{subfigure}
    \\[0.5em]
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{figures/photoredox_weight_distributions.png}
        \caption{Photoredox Yield}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{figures/wine_weight_distributions.png}
        \caption{Wine Quality}
    \end{subfigure}
    \caption{Weight distributions for correct (green) and incorrect (red) hypotheses after the four-iteration soft refinement process across all four benchmark datasets. The distributions show how GGH assigns higher weights to correct hypotheses and lower weights to incorrect ones. Partial correct data (known ground truth) enters at weight 1.0.}
...
% Photocell R2 boxplot
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/photocell_r2_boxplot.png}
    \caption{$\Rsq$ score distribution across 15 runs for the Photocell Degradation imputation benchmark. GGH achieves a median $\Rsq$ substantially higher than all competitors.}
    \label{fig:photocell_r2_boxplot}
\end{figure}
...
% Photoredox R2 boxplot
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/photoredox_r2_boxplot.png}
    \caption{$\Rsq$ score distribution across 15 runs for the Photoredox Yield imputation benchmark.}
    \label{fig:photoredox_r2_boxplot}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/airfoil_r2_boxplot.png}
    \caption{$\Rsq$ score distribution across 15 runs for the Airfoil Self-Noise imputation benchmark.}
    \label{fig:airfoil_r2_boxplot}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/wine_r2_boxplot.png}
    \caption{$\Rsq$ score distribution across 15 runs for the Wine Quality imputation benchmark. GGH is the only method that consistently achieves positive $\Rsq$ across all runs.}
    \label{fig:wine_r2_boxplot}
\end{figure}
